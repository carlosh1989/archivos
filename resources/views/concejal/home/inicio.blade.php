...
<div class="container">
  <div class="card-panel">
    ...
    <a class="btn blue" href=""><i class="fa fa-book" aria-hidden="true"></i> Manual</a>
    <a class="btn blue" href=""><i class="fa fa-file-video-o" aria-hidden="true"></i> Video Tutorial</a>
  </div>
